...
public class HeroAppSteps {
    ...
    public void userShouldSeeAMessageStartsWith(String startsWithInvalidMessage) {
        Assert.assertTrue(heroAppPage.invalidMessage.getText().startsWith(startsWithInvalidMessage));
        //   Assert.assertEquals(startsWithInvalidMessage,heroAppPage.invalidMessage.getText());
    }
}
